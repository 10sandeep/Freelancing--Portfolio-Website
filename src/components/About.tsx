...
import { Code, Sparkles, Zap, Layers, Brain, LineChart, Award, Briefcase, Rocket } from "lucide-react";
...
const About = () => {
  ...
  const experienceData = [
    { year: "2020", project: "E-commerce Platform", role: "Frontend Developer" },
    { year: "2021", project: "Mobile Banking App", role: "Full-stack Developer" },
    { year: "2022", project: "IoT Dashboard", role: "UI/UX Designer & Developer" },
    { year: "2023", project: "AI Content Platform", role: "Lead Developer" },
    { year: "2024", project: "Web3 Application", role: "Technical Architect" }
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gray-900/60 backdrop-blur-sm border border-gray-800 rounded-2xl p-8 shadow-2xl shadow-cyan-500/5">
            <div className="flex flex-wrap gap-2 mb-8 border-b border-gray-800 pb-4">
              {[
                { id: "story", label: "My Story", icon: <Sparkles size={18} /> },
                { id: "skills", label: "Skills", icon: <Brain size={18} /> },
                { id: "journey", label: "Journey", icon: <LineChart size={18} /> }
              ].map((tab) => (
                <button
                  key={tab.id}
                ...
                <div className="grid md:grid-cols-5 gap-8 items-center">
                  <div className="md:col-span-3 space-y-6">
                    ...
                    <p className="text-gray-300 leading-relaxed">
                      I'm a passionate full-stack developer with a creative eye for design and a systematic approach to problem-solving. With over 5 years of experience, I've transformed complex challenges into elegant digital solutions.
                    </p>
                    <p className="text-gray-300 leading-relaxed">
                      My philosophy centers around creating technology that feels intuitive and delightful. I believe the best digital experiences are those that blend seamlessly with human needs, providing value while remaining invisible in their complexity.
                    </p>
                    
                    <div className="grid grid-cols-2 gap-4 pt-4">
                      {[
                        { Icon: Code, title: "Clean Code", desc: "Crafting elegant, readable solutions" },
                        { Icon: Zap, title: "Performance", desc: "Optimizing for lightning-fast experiences" },
                        { Icon: Layers, title: "Architecture", desc: "Building scalable system foundations" },
                        { Icon: Brain, title: "Innovation", desc: "Pushing boundaries with new approaches" }
                      ].map((item, i) => (
                        <div
                          key={i}
                    ...
                    <div className="aspect-square rounded-2xl overflow-hidden relative group">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="text-center px-6">
                          ...
                          <h4 className="text-xl font-bold mb-2">Sandeep Nayak</h4>
                ...
                <div className="space-y-8">
                        ...
                        <div className="w-full h-3 bg-gray-800/70 rounded-full overflow-hidden backdrop-blur-sm">
                          <div 
                            ...
                            style={{ 
                              ...
                              background: "linear-gradient(90deg, rgba(34,211,238,1) 0%, rgba(125,83,219,1) 100%)"
                            }}
                          >
                  ...
                  <div className="grid grid-cols-3 gap-6 mt-8">
                    {[
                      ...
                      >
                        <h4 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-500">{stat.value}</h4>
                    ...
                    <div className="space-y-12">
                      {experienceData.map((exp, i) => (
                        <div key={i} className={`relative flex items-center ${i % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                          <div className={`flex-1 ${i % 2 === 0 ? 'md:pr-12 text-right' : 'md:pl-12'}`}>
                            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-6 rounded-xl border border-gray-800 hover:border-cyan-500/30 transition-all duration-300">
                              <span className="text-sm text-cyan-400 font-medium">{exp.year}</span>
                              <h4 className="text-xl font-bold mt-2 mb-1">{exp.project}</h4>

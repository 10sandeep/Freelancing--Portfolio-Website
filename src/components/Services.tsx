      ...
      <div className="relative z-10 p-6">
        ...
        <ul className="space-y-2">
          {service.features.map((feature, idx) => (
            <li
              key={idx}
              className="flex items-center space-x-2 text-gray-400 group-hover:text-gray-300 transition-colors duration-300"
            >
  ...
  const services = [
    {
      ...
      description:
        "Creating fast, secure, and scalable websites using the latest technologies for a smooth user experience.",
    ...
    },
    {
      ...
      description:
        "Designing clean, user-friendly interfaces that deliver smooth and engaging digital experiences.",
    ...
    },
    {
      ...
      description:
        "Building high-performance, cross-platform mobile apps with smooth user experiences and modern features.",
    ...
    },
    {
      ...
      description:
        "Building powerful and reliable server-side systems to support fast, secure, and scalable applications.",
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            Pioneering solutions to propel your business into the future,
            combining advanced technology with strategic innovation.
          </p>
        </div>
        ...
        <div
          className={`mt-24 bg-gradient-to-br from-gray-900 to-gray-950 rounded-2xl p-8 md:p-12 border border-gray-800 shadow-xl transition-all duration-1000 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
          }`}
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Elevating digital experiences through a perfect fusion of advanced
            ...
            {[
              {
                ...
                description:
                  "Accelerated development cycles using next-gen tools and optimized workflows that deliver results at quantum speed.",
                color: "cyan",
                delay: 700,
              },
              {
                ...
                description:
                  "Deep partnerships built on transparency, constant communication, and a shared vision of your digital future.",
                color: "blue",
                delay: 800,
              },
              {
                ...
                description:
                  "Every project engineered with measurable metrics and data-driven insights to maximize ROI and business impact.",
                color: "purple",
                delay: 900,
              },
            ].map((item, index) => (
              <div
                key={index}
                className={`group relative bg-gradient-to-br from-gray-900 to-gray-950 rounded-xl p-6 border border-gray-800 hover:border-${
                  item.color
                }-500/50 transition-all duration-500 shadow-lg hover:shadow-${
                  item.color
                }-500/20 ${
                  isVisible
              ...
              >
                <div
                  className={`relative flex items-center justify-center w-12 h-12 mb-5 bg-${item.color}-500/10 rounded-lg border border-${item.color}-500/20 group-hover:border-${item.color}-500/50 transition-all duration-300`}
                >
                  {item.icon}
                </div>
                ...
                <div
                  className={`absolute bottom-0 left-0 h-1 w-0 group-hover:w-full bg-gradient-to-r from-${item.color}-500/50 to-${item.color}-500/20 transition-all duration-700 ease-out`}
                ></div>
              </div>
            ))}
          </div>
